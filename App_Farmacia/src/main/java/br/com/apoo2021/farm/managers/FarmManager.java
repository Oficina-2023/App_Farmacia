    ...
    public void updateFarmData(){
        Thread farmName = new Thread(() -> {
            ...
            if(nomeList != null && !nomeList.isEmpty()){
                ...
                EasyFarma.logger.error("Erro ao carregar o nome do farmaceutico!");
            }
        });
        ...
        Thread farmPhone = new Thread(() -> {
            ...
            if(telefoneList != null && !telefoneList.isEmpty()){
                ...
                EasyFarma.logger.error("Erro ao carregar o telefone do farmaceutico!");
            }
        });
        ...
        Thread farmCpf = new Thread(() -> {
            ...
            if(cpfList != null && !cpfList.isEmpty()){
                ...
                EasyFarma.logger.error("Erro ao carregar o cpf do farmaceutico!");
            }
        });
        ...
        try {
            ...
            EasyFarma.logger.error("Error ao aguardar a finalização dos threads de carregamento do farmaceutico!", e);
        }
    }
